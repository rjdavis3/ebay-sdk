...
public class InventoryClientDriver {
	...
	private final Client REST_CLIENT = ClientBuilder.newClient().property(ClientProperties.CONNECT_TIMEOUT, 60000)
	...
	public void givenSomeSkuWhenRetrievingInventoryItemThenReturnInventoryItem() throws Exception {
		final InventoryClient inventoryClient = new InventoryClientImpl(REST_CLIENT, OAUTH_USER_TOKEN);
